...
print('Sample data', data[1:20], [reverse_dictionary[i] for i in data[1:20]])
...
with tf.Session(graph=graph) as session:
  ...
  with open("model/nce_embeddings.pkl", "wb") as fp:   #Pickling
    pickle.dump(final_embeddings, fp)
  with open("model/nce_rev_dict.pkl", "wb") as fp:   #Pickling
    pickle.dump(reverse_dictionary, fp)
  with open("model/nce_dict.pkl", "wb") as fp:   #Pickling
